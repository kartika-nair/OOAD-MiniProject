...
public class Bill_RoomRec extends javax.swing.JFrame {
    ...
    private void Get_Data(){
         try{
                String sql="Select BillNo as 'Bill No.',PatientRegistration.PatientID as 'Patient ID',PatientRegistration.PatientName as 'Patient Name',PatientRegistration.Gen as 'Gender',PatientRegistration.BG as 'Blood Group',Bill_Room.ServiceCharges as 'Service Charges',Bill_Room.BillingDate as 'Billing Date',PaymentMode as 'Payement Mode',TotalCharges as 'Total Charges',NoOfDays as 'No. Of Days' from PatientRegistration,AdmitPatient_Room,Bill_Room where PatientRegistration.PatientID=AdmitPatient_Room.PatientID order by BillNo"; 
