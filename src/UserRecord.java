    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            if (rs.next()) {
                ...
                u1.txtUsername.setText(add1);
                String add2 = rs.getString("password");
                u1.jPassword.setText(add2);
                String add3 = rs.getString("name");
                u1.txtName.setText(add3);
                String add4 = rs.getString("contact_no");
                u1.txtContactno.setText(add4);
                String add5 = rs.getString("email_id");
                u1.txtEmailid.setText(add5);
                u1.Save.setEnabled(false);
                u1.Delete.setEnabled(true);
                u1.Update.setEnabled(true);
